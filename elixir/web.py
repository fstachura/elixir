...
def get_request_context(environ):
    ...
    return RequestContext(get_config(environ), environment, logging.getLogger(__name__))
...
def get_application():
    ...
    app.add_route('/api/acp/{project:project}/{version:version}/{ident_prefix:ident}', AutocompleteResource())
