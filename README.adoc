...
----
sudo apt install python3-pip python3-venv python3-bsddb3 universal-ctags perl git apache2 libapache2-mod-wsgi-py3 libjansson4
----
...
---
python -m venv --system-site-packages /usr/local/elixir/venv
...
Other HTTP servers (like nginx or lighthttpd) may not support WSGI and may require a WSGI server, like uWSGI.
