...
# #include "file"
# Example: musl/v1.2.5/source/src/dirent/dirfd.c
# `#include "__dirent.h"`, line 2
class CppIncFilter(Filter):
    ...
    def check_if_applies(self, ctx, path: str) -> bool:
        return super().check_if_applies(ctx, path) and \
                extension_matches(path, {'dts', 'dtsi', 'c', 'cc', 'cpp', 'c++', 'cxx', 'h', 's'})
